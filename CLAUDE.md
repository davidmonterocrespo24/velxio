...
- Tests: `packages/sdk/test/*.test.ts` (228), `frontend/src/__tests__/EventBus.test.ts` (17), `frontend/src/__tests__/CompileMiddleware.test.ts` (15), `frontend/src/__tests__/spice-mapper-registry.test.ts` (18), `frontend/src/__tests__/component-registry-sdk.test.ts` (12), `frontend/src/__tests__/part-simulation-registry-sdk.test.ts` (13), `frontend/src/__tests__/plugin-host.test.ts` (26), `frontend/src/__tests__/plugin-host-sdk003.test.ts` (14), `frontend/src/__tests__/plugin-host-sdk004.test.ts` (19), `frontend/src/__tests__/plugin-host-sdk005.test.ts` (22), `frontend/src/__tests__/plugin-host-sdk006.test.ts` (20), `frontend/src/__tests__/plugin-host-sdk007.test.ts` (11), `frontend/src/__tests__/SlotOutlet.test.tsx` (18, jsdom), `frontend/src/__tests__/SettingsForm.test.tsx` (14, jsdom), `frontend/src/__tests__/PluginConsentDialog.test.tsx` (17, jsdom), `frontend/src/__tests__/PluginUpdateDiffDialog.test.tsx` (20, jsdom), `backend/tests/test_compile_middleware.py` (15). Frontend full suite: ~1198 (4 pre-existing flaky long-running tests: EventBus 1M-emit perf budget + ILI9341 boot + Mega blink + Pong setup-wait + spice-rectifier-live RAF — all timeout-sensitive under contention). All wired into CI (`.github/workflows/sdk-tests.yml`, `frontend-tests.yml`, `backend-unit-tests.yml`).
