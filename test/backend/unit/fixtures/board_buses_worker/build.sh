...
for name in spi-probe i2c-probe touch-probe free-probe block-probe; do
...
echo "built: spi-probe.wasm i2c-probe.wasm touch-probe.wasm free-probe.wasm block-probe.wasm"
